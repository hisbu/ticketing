        ...
        return(
            <div className="">
                <div className="bgVideo">
                    ...
                    <iframe width="100%" height="400" title="triler" src={this.state.data.thriller} frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
                </div>
                        ...
                        <div className="row ">
                            ...
                            <div className='col-md-9 '>
                                <div className="contentBox">
                                    ...
                                    <div className="voteDetail  d-flex">
                                        <div className="thumbsContainer">
                                            <div className="thumbsDetail "><FontAwesomeIcon icon={faThumbsUp}/><span>73%</span></div>
                                            <div className="voteSUm">41 votes</div>
                                        </div>
                                        <div className="will ml-4"><FontAwesomeIcon icon={faThumbsUp}/>  WWILL WATCH (31)</div>
                                        <div className="maybe ml-4"><FontAwesomeIcon icon={faQuestion}/>  MAYBE (31)</div>
                                        <div className="wont ml-4"><FontAwesomeIcon icon={faThumbsDown}/>  WON'T WATCH (31)</div>
                                    </div>
